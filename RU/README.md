...
* Если в блоке кода всего одна команда то она автоматически будет возвращаться черер блок `return` даже не указывая его
    ...
    То есть `a1` будет автоматически возвращаться